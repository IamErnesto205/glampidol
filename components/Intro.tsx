    ...
    <section className="bg-cream">
      <div className="mx-auto grid w-full max-w-[1280px] items-center gap-12 px-6 py-24 lg:grid-cols-12 lg:gap-16 lg:px-8 lg:py-36">
        <Reveal className="lg:col-span-7">
          <Eyebrow>Vítejte v sadu</Eyebrow>
          <h2 className="mt-6 font-display text-3xl leading-[1.15] font-semibold tracking-tight text-ink sm:text-4xl lg:text-[2.9rem]">
            Ráno s výhledem. Večer v sauně.{" "}
            <span className="text-olive">
              Klid, který se nevejde do kalendáře.
            </span>
          </h2>
          <p className="mt-7 max-w-xl text-base leading-[1.85] font-light text-ink/75 sm:text-lg">
            Uprostřed trnkového sadu, v objetí Vizovických vrchů, najdete
            místo, kde se zpomalí čas. Ráno si sednete k velkému oknu s kávou,
            přes den vyrazíte na výlet nebo jen zůstanete na terase a večer
            necháte saunu, aby z vás smyla poslední zbytky města.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.15} className="relative lg:col-span-5">
          <div className="relative aspect-[4/5] overflow-hidden rounded-sm">
            <Image
              src={IMAGES.orchard.src}
              alt={IMAGES.orchard.alt}
              fill
